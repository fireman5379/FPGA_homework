...
HD_PWD='D:/FPGA/snake_basys3/snake_basys3.runs/pic_slowly_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pic_slowly.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pic_slowly.tcl
